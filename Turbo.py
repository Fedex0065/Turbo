...
rossa=pygame.image.load('macchina_rossa.png')
blu=pygame.image.load('macchina_blu.png')
viola=pygame.image.load('macchina_viola.png')
verde=pygame.image.load('macchina_verde.png')
gialla=pygame.image.load('macchina_gialla.png')
